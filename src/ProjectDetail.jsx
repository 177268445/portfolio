    ...
    <main className="case-study">
      ...
      <section className="case-hero case-frame">
        ...
        <div className="case-hero-visual" aria-hidden="true">
          ...
          <div className="hero-screen"><img src="/assets/aishinye/cover.png" alt="" /></div>
      ...
      <section className="case-frame dashboard-section">
        ...
        <div className="dashboard-screen"><img src="/assets/aishinye/cover.png" alt="运营工作台界面" loading="lazy" /></div>
      </section>
      ...
      <section className="case-frame system-section">
        ...
        <div className="system-image"><img src="/assets/aishinye/drawer.png" alt="爱新芽组件界面" loading="lazy" /></div>
      ...
      <section className="case-frame key-pages-section">
        ...
        <div className="page-wall">
          {[
            ['/assets/aishinye/case-analysis.png', '病例分析'], ['/assets/aishinye/review.png', '资料审核'], ['/assets/aishinye/case-detail.jpg', '病例详情'], ['/assets/aishinye/shipping.png', '出库发货'], ['/assets/aishinye/patient-form.png', '患者资料采集'], ['/assets/aishinye/plan-review.png', '方案审阅'],
